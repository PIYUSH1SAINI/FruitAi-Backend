...
app.config["MONGO_URI"] = "mongodb+srv://piyushsaini20001:Piyushsaini@fruitai.7joxq.mongodb.net/"
...
fruits = {
  ...
  "dragonfruit": {
    "name": "Dragonfruit",
    "description": "A tropical fruit with vibrant pink skin and white or red flesh.",
